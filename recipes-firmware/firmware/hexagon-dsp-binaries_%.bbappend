...
QCM6490_SRC_URI ?= "${FW_ARTIFACTORY}/${QCM6490_FW_BUILD_ID}/${QCM6490_FW_BIN_PATH}/QCM6490_dspso.zip;name=QCM6490_dspso"
QCS9100_SRC_URI ?= "${FW_ARTIFACTORY}/${QCS9100_FW_BUILD_ID}/${QCS9100_FW_BIN_PATH}/QCS9100_dspso.zip;name=QCS9100_dspso"
QCS8300_SRC_URI ?= "${FW_ARTIFACTORY}/${QCS8300_FW_BUILD_ID}/${QCS8300_FW_BIN_PATH}/QCS8300_dspso.zip;name=QCS8300_dspso"
QCS615_SRC_URI  ?= "${FW_ARTIFACTORY}/${QCS615_FW_BUILD_ID}/${QCS615_FW_BIN_PATH}/QCS615_dspso.zip;name=QCS615_dspso"

SRC_URI[QCM6490_dspso.sha256sum] = "${QCM6490_DSPSO_SHA256SUM}"
SRC_URI[QCS9100_dspso.sha256sum] = "${QCS9100_DSPSO_SHA256SUM}"
SRC_URI[QCS8300_dspso.sha256sum] = "${QCS8300_DSPSO_SHA256SUM}"
SRC_URI[QCS615_dspso.sha256sum] = "${QCS615_DSPSO_SHA256SUM}"
